...
export interface paths {
    ...
    "/users/result": {
        ...
        /** Get Results */
        get: operations["users_get_results"];
        put?: never;
        /**
         * Add Result
         * @description Add result to user; if not exist will create it
         */
        post: operations["users_add_result"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/users/result/{level_name}": {
        ...
        /** Get Results By Level Name */
        get: operations["users_get_results_by_level_name"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        LevelLeaderboardResp: {
             ...
             */
            user_id: string;
            lvlInfo: components["schemas"]["LevelMetaInfo"];
        };
        /** LevelMetaInfo */
        LevelMetaInfo: {
            /** Level Name */
...
export interface operations {
    ...
    users_add_result: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AddResultReq"];
            };
        };
        responses: {
            /** @description Result was added successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    users_get_results_by_level_name: {
        parameters: {
            query?: never;
            header?: never;
            path: {
